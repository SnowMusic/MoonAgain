...
public class MainActivity extends AppCompatActivity
    ...
    private void initView() {
        ...
        for (int i = 0; i < 15; i++) {
            Button view = (Button) LayoutInflater.from(this).inflate(R.layout.testbutton, null);
            tabNamesList.add("哈哈哈哈寒暑假回家" + i);
            view.setText(i + "哈哈哈哈寒暑假回家");
            viewsList.add(view);
        }
        ...
        tabIndicator.setViewPager(vp, 0);
